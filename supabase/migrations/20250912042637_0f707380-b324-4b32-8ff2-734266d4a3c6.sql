...
('ตลาดดำเนินสะดวก', 'สัมผัสวิถีชีวิตแบบไทยๆ เยี่ยมชมตลาดน้ำโบราณ ลิ้มรสอาหารพื้นบ้าน', '/src/assets/market-package.jpg', 3500.00, 1, 'ราชบุรี', ARRAY['วัฒนธรรม', 'อาหาร', 'ตลาดน้ำ'], 4.6, 89),
